try{
[CmdletBinding()]
$ShortcutTargetPath = "C:\Program Files\VideoLAN\VLC\vlc.exe"

$ShortcutDisplayName = "VLC media player"

$PinToStart= "true"

$IconFile= "C:\Program Files\VideoLAN\VLC\vlc.exe, 0"
...
function Add-Shortcut {
    ...
    process{
        ...
        [Runtime.InteropServices.Marshal]::ReleaseComObject($WshShell) | Out-Null
            ...
            $startMenuDir= Join-Path $env:ALLUSERSPROFILE "Microsoft\Windows\Start Menu\Programs\VideoLAN\VLC"
