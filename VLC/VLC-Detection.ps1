...
$shortcutName="VLC media player"
#Define Start Menu Location
$StartMenuDir = Join-Path -Path $env:ALLUSERSPROFILE -ChildPath "Microsoft\Windows\Start Menu\Programs\VideoLAN\VLC"
#Define executable path
$ExectuablePath = "C:\Program Files\VideoLAN\VLC\vlc.exe"
