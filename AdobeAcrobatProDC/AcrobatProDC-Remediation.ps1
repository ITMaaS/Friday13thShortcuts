try{
[CmdletBinding()]
$ShortcutTargetPath = "C:\Program Files (x86)\Adobe\Acrobat DC\Acrobat\Acrobat.exe"

$ShortcutDisplayName = "Adobe Acrobat DC"

$PinToStart= "true"

$IconFile= "C:\Program Files (x86)\Adobe\Acrobat DC\Acrobat\Acrobat.exe, 0"
