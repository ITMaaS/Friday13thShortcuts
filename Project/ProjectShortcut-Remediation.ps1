try{
[CmdletBinding()]
$ShortcutTargetPath = "C:\Program Files\Microsoft Office\root\Office16\WINPROJ.EXE"

$ShortcutDisplayName = "Project"

$PinToStart= "true"

$IconFile= "C:\Program Files\Microsoft Office\root\Office16\WINPROJ.EXE, 0"
