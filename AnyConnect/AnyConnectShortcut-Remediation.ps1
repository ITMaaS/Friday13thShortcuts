try{
[CmdletBinding()]
$ShortcutTargetPath = "C:\Program Files (x86)\Cisco\Cisco AnyConnect Secure Mobility Client\vpnui.exe"

$ShortcutDisplayName = "Cisco AnyConnect Secure Mobility Client"

$PinToStart= "true"

$IconFile= "C:\Program Files (x86)\Cisco\Cisco AnyConnect Secure Mobility Client\vpnui.exe, 0"
...
function Add-Shortcut {
    ...
    process{
        ...
        [Runtime.InteropServices.Marshal]::ReleaseComObject($WshShell) | Out-Null
            ...
            $startMenuDir= Join-Path $env:ALLUSERSPROFILE "Microsoft\Windows\Start Menu\Programs\Cisco\Cisco AnyConnect Secure Mobility Client"
