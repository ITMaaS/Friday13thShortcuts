...
$shortcutName="Cisco AnyConnect Secure Mobility Client"
#Define Start Menu Location
$StartMenuDir = Join-Path -Path $env:ALLUSERSPROFILE -ChildPath "Microsoft\Windows\Start Menu\Programs\Cisco\Cisco AnyConnect Secure Mobility Client"
#Define executable path
$ExectuablePath = "C:\Program Files (x86)\Cisco\Cisco AnyConnect Secure Mobility Client\vpnui.exe"
